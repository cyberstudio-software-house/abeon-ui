...
import { Users, FileText, ShoppingCart, Bot, Mail, Calendar, BarChart3, Settings, MessageSquare } from "lucide-react";
...
export const Interactive: StoryObj = {
  render: () => {
    ...
    return (
      <AppShell
        collapsed={collapsed}
        sidebar={<AppSidebar navGroups={mockNavGroups} collapsed={collapsed} onCollapsedChange={setCollapsed} mobileOpen={mobileOpen} onMobileOpenChange={setMobileOpen} />}
        topbar={<Topbar apps={mockApps} currentAppId="crm" notifications={mockNotifications} unreadCount={2} user={mockUser} sidebarCollapsed={collapsed} onNotificationRead={() => {}} onNotificationReadAll={() => {}} onSignOut={() => {}} />}
      >
        <p className="text-foreground">Page content renders here</p>
      </AppShell>
    );
  },
};
