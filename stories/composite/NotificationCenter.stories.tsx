...
const mockNotifications: NotificationItem[] = [
  { id: "1", icon: Users, colorVariant: "primary", title: "Nowy kontakt", message: "Jan Kowalski dodał nowy kontakt do CRM", time: "2 min temu", read: false, href: "/crm/contacts/42" },
